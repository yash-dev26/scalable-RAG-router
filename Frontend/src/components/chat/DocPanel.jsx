  ...
  return (
    <div className="w-80 min-w-80 bg-slate-800 border-l border-slate-700 overflow-y-auto p-5">
      <div className="flex items-center justify-between mb-5 pb-2.5 border-b border-slate-700">
        <span className="text-xs text-slate-400 tracking-[0.18em] uppercase">Retrieved Context</span>
      ...
      {sources.length === 0 ? (
        ...
        sources.map((doc) => (
          ...
          >
            ...
            <p className="text-xs text-slate-300 leading-relaxed mb-2">{doc.text}</p>
